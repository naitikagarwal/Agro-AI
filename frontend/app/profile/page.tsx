    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-20 pb-10">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-extrabold text-emerald-900">{farmer.name}</h1>
          <p className="text-sm text-slate-600">{farmer.location}</p>
          <p className="text-xs text-slate-500 mt-1">Joined {new Date(farmer.joined).toLocaleDateString()}</p>
          <p className="mt-3 text-slate-700 max-w-md mx-auto italic">{farmer.bio}</p>
