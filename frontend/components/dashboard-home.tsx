        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-800 p-6 rounded-md border border-gray-700">
              <p className="text-base font-medium text-gray-300">Datasets</p>
              <p className="text-3xl font-bold mt-2">120</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-md border border-gray-700">
              <p className="text-base font-medium text-gray-300">Sensors</p>
              <p className="text-3xl font-bold mt-2">350</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-md border border-gray-700">
              <p className="text-base font-medium text-gray-300">Models</p>
