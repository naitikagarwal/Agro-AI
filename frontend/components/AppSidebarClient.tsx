                        ...
                        {isOpen && (
                          ...
                          >
                            ...
                            {days.length > 0 ? (
                              ...
                              <div className="px-3 py-2 text-sm text-green-700/60">
                                No days yet
                              </div>
                            )}
                          </div>
      ...
      <SidebarFooter>
        <SidebarMenuItem>
          <SidebarMenuButton
            ...
            className="w-full flex items-center gap-3 px-4 py-2 rounded-2xl text-green-900 font-medium transition-all hover:bg-green-100 hover:text-green-950 focus:outline-none focus:ring-2 focus:ring-green-300"
          >
